...
const stravaData = require('../stravadatabase/18_07_07_17_46.json');
...
const actions: ActionTree<State, State> = {
  ...
  [MutationTypes.SET_SELECTED_DISPLAYTYPE]: ({commit}, type) => {
    commit(MutationTypes.SET_SELECTED_DISPLAYTYPE, {
      type
    });
  },
  ...
  [MutationTypes.SET_DASHBOARD_VIEWTYPE]: ({commit}, payload) => {
    console.log('actions', payload);
    commit(MutationTypes.SET_DASHBOARD_VIEWTYPE, {
      payload
    });
  },
